...
[previous tutorial](iot-sensors.md) so that measurements can be read
...
HTTP requests generated by the Orion Context Broker and passed downwards towards an IoT device (via
