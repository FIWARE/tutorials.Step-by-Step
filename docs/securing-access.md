...
entities created in the [previous tutorial](roles-permissions.md). The tutorial
explains appropriate use of the various OAuth2 grant flows, and how to use the
**Keyrock** generic enabler as an Authorization Server to identify users.
...
roles and permisions within the [previous tutorial](roles-permissions.md), and
