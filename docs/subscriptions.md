...
the [NGSI](https://fiware.github.io/specifications/OpenAPI/ngsiv2) Subscribe/Notify paradigm and how to use NGSI
...
[![Run in Postman](https://run.pstmn.io/button.svg)](https://app.getpostman.com/18ea15017244c70d1fe4)
