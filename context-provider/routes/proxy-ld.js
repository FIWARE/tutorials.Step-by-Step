...
function notSupported(req, res) {
    ...
    res.send({
        ...
        detail: "The '" + req.params.proxy + "' context provider does not support the given endpoint"
    });
}
...
router.get('/random/weatherConditions/ngsi-ld/v1/entities/:id', weatherDefaults, RandomNGSIProxy.getAsNgsiLD);

router.get('/static/weatherConditions/ngsi-ld/v1/entities/:id', weatherDefaults, StaticNGSIProxy.getAsNgsiLD);
...
router.patch('/static/tweets/ngsi-ld/v1/entities/:id/attrs', tweetDefaults, StaticNGSIProxy.updateEntity);
router.patch('/static/weatherConditions/ngsi-ld/v1/entities/:id/attrs', weatherDefaults, StaticNGSIProxy.updateEntity);

// Updatable Endpoints
router.patch('/static/:attributes/ngsi-ld/v1/entities/:id/attrs/temperature', (req, res) => {
    req.params.type = 'number';
    StaticNGSIProxy.updateSingleAttribute(req, res);
});
router.patch('/static/:attributes/ngsi-ld/v1/entities/:id/attrs/relativeHumidity', (req, res) => {
    req.params.type = 'number';
    StaticNGSIProxy.updateSingleAttribute(req, res);
});
router.patch('/static/:attributes/ngsi-ld/v1/entities/:id/attrs/tweets', (req, res) => {
    req.params.type = 'list';
    StaticNGSIProxy.updateSingleAttribute(req, res);
});
